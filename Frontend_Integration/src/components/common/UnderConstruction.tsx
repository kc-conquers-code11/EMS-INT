export const UnderConstruction = ({ pageName }: { pageName?: string }) => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
    <div className="w-16 h-16 bg-[#f0f2ff] rounded-2xl flex items-center justify-center">
      <svg className="w-8 h-8 text-[#0e1680]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <h2 className="text-xl font-semibold text-[#1d2939]">
      {pageName ?? 'This page'} is under construction
    </h2>
    <p className="text-[#687b96] text-sm">Check back soon.</p>
  </div>
);