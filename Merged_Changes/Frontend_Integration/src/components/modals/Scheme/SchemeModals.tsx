...
export interface SchemeFeedbackModalProps {
  isOpen: boolean;
  type: SchemeFeedbackType;
  message?: string;
  onClose: () => void;
  onConfirm?: () => void;
}

export const SchemeFeedbackModal: React.FC<SchemeFeedbackModalProps> = ({ isOpen, type, message, onClose, onConfirm }) => {
    ...
    switch (type) {
      ...
      case 'edit_success':
        return { 
          ...
          title: message || (type === 'add_success' ? 'Scheme added successfully !!' : 'Scheme edited successfully !!'), 
          primaryBtn: 'Back', 
          secondaryBtn: 'Cancel',
          showSecondary: false 
        };
      case 'delete_confirm':
        return { 
          ...
          title: message || 'Do you really want to delete this Scheme?', 
          primaryBtn: 'Delete', 
          secondaryBtn: 'Cancel', 
          showSecondary: true 
        };
      case 'delete_success':
        return { 
          ...
          title: message || 'Scheme deleted successfully !!', 
          primaryBtn: 'Back', 
          secondaryBtn: 'Cancel',
          showSecondary: false 
        };
